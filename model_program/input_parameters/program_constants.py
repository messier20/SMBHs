...
from model_program.input_parameters.program_units import unit_year, unit_kpc
...
RADIUS_MAX = 15./unit_kpc             #;stop the simulation once the c.d. reaches this radius
