...
def plotting_histogram(dot_radius_arr, dot_mass_arr, time_arr, index):
    ...
    fig1.savefig(path+ name + 'hist_v2'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig1)
    ...
    fig2.savefig(path + name + 'hist_zoomed_v1'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig2)
    ...
    fig3.savefig(path + name + 'hist_vel_fg05'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig3)
    ...
    fig4.savefig(path + name + 'hist_vel_fg01'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig4)
    ...
    fig5.savefig(path + name + 'hist_vel_fg025'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig5)
    ...
    fig6.savefig(path + name + 'hist_vel_fg05'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig6)
    ...
    fig7.savefig(path + name + 'hist_vel_fg1'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig7)
    ...
    fig1.savefig(path + name + 'hist_dmass_more_than6_less3500'+str(index)+'.png', bbox_inches='tight')
    plt.close(fig1)
